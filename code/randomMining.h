 ...
 * Email: tksaha@cs.iupui.edu; nataycse@gmail.com
...
private:
	...
	char *datafile;
	bool isundir;
	int sizeOfSubgrah,supportValue,temp[10],Qsize,fillerlength,stepSize;
	int graphIndex,gxpopcount,gypopcount,uniqgxpopcount,uniqgypopcount;
...
/* Variable related to random Graph Sampler */
	...
	double sampleTime,codeGenTime, insertHeapTime;
	double  microsec;
...
/*Methods related to Parser */
   	string  makeFillerForString(string mystring);  
		...
		std::cout<<"Usage: "<<progname<<" -d data-file -i iteration -s sizeOfSubgrah -step stepSize"<<endl;
    	}
